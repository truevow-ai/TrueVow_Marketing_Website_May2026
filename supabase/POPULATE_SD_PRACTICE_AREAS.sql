-- South Dakota Practice Area Data
-- Generated: 2025-12-02T02:35:32.887Z
...
WHERE state_code = 'SD' AND county_slug = 'minnehaha'
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'SD' AND county_slug = 'pennington'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'SD' AND county_slug = 'lincoln'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
