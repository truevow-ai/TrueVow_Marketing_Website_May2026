-- Vermont Practice Area Data
-- Generated: 2025-12-02T02:25:01.559Z
...
WHERE state_code = 'VT' AND county_slug = 'chittenden'
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'VT' AND county_slug = 'rutland'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'VT' AND county_slug = 'windsor'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
