-- Hawaii Practice Area Data
-- Generated: 2025-12-02T02:25:02.332Z
...
WHERE state_code = 'HI' AND county_slug = 'honolulu'
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'HI' AND county_slug = 'maui'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'HI' AND county_slug = 'hawaii'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
