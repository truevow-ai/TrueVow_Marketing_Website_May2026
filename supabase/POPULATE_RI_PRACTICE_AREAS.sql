-- Rhode Island Practice Area Data
-- Generated: 2025-12-02T02:24:57.888Z
...
WHERE state_code = 'RI' AND county_slug = 'providence'
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'RI' AND county_slug = 'kent'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'RI' AND county_slug = 'washington'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
