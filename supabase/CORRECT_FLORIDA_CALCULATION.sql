-- CORRECT CALCULATION: total_seats = 33% of total_firms (NOT 33% of solo/small firms)
-- Formula: total_seats = ROUND(total_firms * 0.33)
-- Minimum: 2 seats for small counties, 8 seats for larger counties
...
WHERE state_code = 'FL' AND county_slug IN ('st-johns', 'glenn', 'baker', 'calhoun')
