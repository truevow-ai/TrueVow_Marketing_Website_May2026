-- Louisiana Practice Area Data
-- Generated: 2025-12-02T02:00:03.758Z
...
WHERE state_code = 'LA' AND county_slug = 'orleans'
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'LA' AND county_slug = 'jefferson'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'LA' AND county_slug = 'st-tammany'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'LA' AND county_slug = 'east-baton-rouge'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'LA' AND county_slug = 'caddo'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'LA' AND county_slug = 'lafayette'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'LA' AND county_slug = 'calcasieu'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'LA' AND county_slug = 'rapides'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
