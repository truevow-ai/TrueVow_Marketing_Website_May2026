-- New Hampshire Practice Area Data
-- Generated: 2025-12-02T02:24:57.545Z
...
WHERE state_code = 'NH' AND county_slug = 'hillsborough'
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'NH' AND county_slug = 'rockingham'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'NH' AND county_slug = 'strafford'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
...
SELECT 
    ...
    1, true
FROM web_availability_county 
WHERE state_code = 'NH' AND county_slug = 'merrimack'
ON CONFLICT (county_availability_id, practice_area_slug) DO UPDATE SET
    practice_area_name = EXCLUDED.practice_area_name,
    total_firms = EXCLUDED.total_firms,
    cap = EXCLUDED.cap,
